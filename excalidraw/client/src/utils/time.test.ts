...
describe('formatRelativeTime', () => {
  ...
  it('falls back to absolute datetime beyond 30 days', () => {
    expect(formatRelativeTime('2024-12-01T08:05:00', NOW)).toBe('2024-12-01 08:05');
  });

  it('falls back to absolute datetime for future timestamps', () => {
    expect(formatRelativeTime('2025-02-01T08:05:00', NOW)).toBe('2025-02-01 08:05');
  });
});
